...
public class FirstAppiumTest_Clock {
...
//        либо в cmd: adb -e shell dumpsys window windows | grep Focus
        ...
        //WebElement searchCities = driver.findElement(AppiumBy.id("com.google.android.deskclock:id/content"));
        //searchCities.click();
        ...
        WebElement colomboTime  = driver.findElement(AppiumBy.accessibilityId("5:59 PM"));
        Assertions.assertEquals("5:59 PM", colomboTime.getText());
...
//    3) Appium Inspector (для получения локаторов)
    ...
    void clockTest2() throws MalformedURLException {
        ...
        WebElement elementCities = driver.findElement(AppiumBy.accessibilityId("Cities"));
        elementCities.click();
        WebElement elemCheckBoxColombo=driver.findElement(AppiumBy.accessibilityId("Colombo"));
        elemCheckBoxColombo.click();
        driver.navigate().back();
