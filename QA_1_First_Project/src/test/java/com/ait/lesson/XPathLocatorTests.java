...
public class XPathLocatorTests extends BaseTest {
    ...
    //* -любой элемент
    //[] индекс элемента html/body/div/div[1]/a[1]   узел тег элемента  / body/div/div[1]/a[1] //div[1]/a[1]
    /*
    ...
    void findElementByXpath() {
        ...
        Assertions.assertTrue(getElementBy(By.xpath("//button[text()='Sign Out']")).isDisplayed(),
