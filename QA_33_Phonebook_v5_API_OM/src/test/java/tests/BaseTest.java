...
public class BaseTest {
    ...
    public static final String REGISTER_ENDPOINT = properties.getProperty("register.endpoint");
    ...
    static ContactDto getRegistrationRq() {
        return ContactDto.builder()
                .id(null)
                .name(properties.getProperty("testuser.name"))
                .lastName(properties.getProperty("testuser.lastName"))
                .phone(properties.getProperty("0123456789"))
